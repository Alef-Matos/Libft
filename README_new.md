...
### List of functions
Libc Função | Additional Função | Bonus Função | Personal Função
:----------- | :-----------: | :-----------: | -----------:
...
Descricao | Param. #1 | Param. #2 | Param. #3 | Retorno
:-----------: | :-----------: | :-----------: | :-----------: | :-----------:
...
Descrição | Param. #1 | Param. #2 | Retorno
:-----------: | :-----------: | :-----------: | :-----------:
...
Descrição | Param. #1 | Param. #2 | Param. #3 | Retorno
:-----------: | :-----------: | :-----------: | :-----------: | :-----------:
...
Descrição | Param. #1 | Param. #2 | Param. #3 | Param. #4 | Retorno
:-----------: | :-----------: | :-----------: | :-----------: | :-----------: | :-----------:
